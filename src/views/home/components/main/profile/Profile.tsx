...
const Profile = () => {
  ...
  useEffect(() => {
    const currentIsProUser = route.params && route?.params?.isProUser;

    if (currentIsProUser !== undefined) {
      setIsProUser(currentIsProUser);
    }
  }, [route.params]);
      ...
      <View
        ...
        <TouchableOpacity
          style={{
            ...
            alignItems: 'center',
            justifyContent: 'center',
            borderTopWidth: !isProUser ? 3.5 : undefined,
            borderColor: !isProUser ? '#396593' : undefined,
          }}
